<cfcomponent>
	...
	<cffunction name="setMatrix" output="false">
	...
	<cffunction name="updateMatrix" output="false">
		<cfargument name="robotID" type="numeric" default="true">
		<cfargument name="x" type="numeric" required="true">
		<cfargument name="y" type="numeric" required="true">
		<cfargument name="mood" type="string" required="true">
	...
	<cffunction name="listNeighbors" hint="Given my co-ordinates on a tile, will return the adjacet tile" output="false">
		<cfargument name="x" type="numeric" required="true">
		<cfargument name="y" type="numeric" required="true">
	...
	<cffunction name="listDiagNeighbors" output="false">
		<cfargument name="x" type="numeric" required="true">
		<cfargument name="y" type="numeric" required="true">
		<cfargument name="tileSize"  type="numeric" required="true" default="#this.tileSize#">
		<cfargument name="totalGridX" type="numeric" required="true" default="#this.totalGridX#">
	...
	<cffunction name="manhattanDist" output="false" >
	...
	<cffunction name="scorePaths" output="false">
		<cfargument name="myX" type="numeric" required="true" >
		<cfargument name="myY" type="numeric" required="true" >
		<cfargument name="targetX" type="numeric" required="true" >
		<cfargument name="targetY" type="numeric" required="true" >
	...
	<cffunction name="scoreDiagPaths" output="false">
		<cfargument name="myX" type="numeric" required="true" >
		<cfargument name="myY" type="numeric" required="true" >
		<cfargument name="targetX" type="numeric" required="true" >
		<cfargument name="targetY" type="numeric" required="true" >
	...
	<cffunction name="isOnGrid" output="false">
		<cfargument name="x" type="numeric" required="true">
		<cfargument name="y" type="numeric" required="true">
		<cfargument name="tileSize"  type="numeric" required="true" default=this.tileSize>
		<cfargument name="totalGridX" type="numeric" required="true" default=this.totalGridX> 
	...
	<cffunction name="moveCloser" output="false">
	...
	<cffunction name="moveAway" output="false">
		<cfargument name="myID" type="numeric" required="true">
		<cfargument name="targetID" type="numeric" required="true">
		<cfargument name="robotMatrix" type="query" required="true">
		<cfset var me ="">
	...
	<cffunction name="moverandom" output="false">
		<cfargument name="myID" type="numeric" required="true">
		<cfargument name="robotMatrix" type="query" required="true">
		<cfset var me ="">
		<cfset var them="">
	...
	<cffunction name="scoreAllTargets" output="false">
		<cfargument name="myID" type="numeric" required="true">
		<cfargument name="robotMatrix" type="query" required="true">
		<cfset var targets = "">
		<cfset var me = "">
	...
	<cffunction name="getClosestTarget" output="false">
		<cfargument name="myID" type="numeric" required="true">
		<cfargument name="robotMatrix" type="query" required="true">
